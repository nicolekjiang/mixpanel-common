...
export function downloadData(endpoint, paramsAsFormTags, method='POST') {
  ...
  // paramsAsFormTags should be html form tags:
  // const paramsAsFormTags = `
  //   <textarea name="script">function main()...</textarea>
  //   <input type="hidden" name="params" value="{foo_param:'bar'}"/>
  // `;
  postForm.innerHTML = paramsAsFormTags;
