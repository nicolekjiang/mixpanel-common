...
/***/ function(module, exports, __webpack_require__) {
	...
	var _colors = __webpack_require__(365);

	var _colors2 = _interopRequireDefault(_colors);

	var _svgIcon = __webpack_require__(351);
	...
	var template = function render(locals) {
	  locals = locals || {};;;var result_of_with = function ($helpers, COLORS, Object, SVG_ICONS, blueToggleValue) {
	    var h = __webpack_require__(348);return { value: h("div", { "className": [].concat('style-guide').filter(Boolean).join(' ') }, [h("div", { "className": [].concat('section').filter(Boolean).join(' ') }, [h("h1", ["Colors"].filter(Boolean)), h("p", { "className": [].concat('item-palette').concat('color-palette').concat('mp-font-list-item').filter(Boolean).join(' ') }, [Object.keys(COLORS).map(function (color, $index) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	};var css = '.mp-button-container {   -webkit-box-align: center;       -ms-flex-align: center;           align-items: center;   border: 1px solid;   border-radius: 4px;   box-shadow: 0px 1px 1px 0px rgba(0,0,0,0.2);   box-sizing: border-box;   cursor: pointer;   display: -webkit-inline-box;   display: -ms-inline-flexbox;   display: inline-flex;   -webkit-box-flex: 1;       -ms-flex: 1;           flex: 1;   font-family: \'HelveticaNeue\', \'Helvetica Neue\', \'HelveticaNeueRoman\', \'HelveticaNeue-Roman\', \'Helvetica Neue Roman\', \'Helvetica\', \'Tahoma\', \'Geneva\', \'Arial\', sans-serif;   font-size: 14px;   font-weight: 600;   -webkit-box-pack: center;       -ms-flex-pack: center;           justify-content: center;   letter-spacing: 0;   line-height: 14px;   padding: 15px 25px 13px 25px;   text-align: center;   text-transform: uppercase;   -webkit-user-select: none;      -moz-user-select: none;       -ms-user-select: none;           user-select: none; /* BEGIN COLOR THEMES */ /* END COLOR THEMES */ /* BEGIN SPECIAL STYLES FOR MODAL BUTTONS */ /* END SPECIAL STYLES FOR MODAL BUTTONS */ } .mp-button-container .mp-button-text {   display: -webkit-inline-box;   display: -ms-inline-flexbox;   display: inline-flex;   -webkit-box-align: center;       -ms-flex-align: center;           align-items: center;   -webkit-box-pack: center;       -ms-flex-pack: center;           justify-content: center; } .mp-button-container .mp-button-text .mp-button-arrow-next {   margin-left: 10px;   width: 15px; } .mp-button-container .mp-button-text .mp-button-arrow-next svg path {   fill: #fff; } .mp-button-container:disabled, .mp-button-container[disabled] {   box-shadow: none;   cursor: default; } .mp-button-container:disabled .mp-button-text, .mp-button-container[disabled] .mp-button-text {   opacity: 0.6; } .mp-button-container.mp-button-primary, .mp-button-container.mp-button-blue {   background-image: -webkit-linear-gradient(bottom, #4ba8ff 0%, #6cb8ff 100%);   background-image: linear-gradient(0deg, #4ba8ff 0%, #6cb8ff 100%);   border-color: #3b99f0;   color: #fff; } .mp-button-container.mp-button-primary:hover:not([disabled]):not(:disabled), .mp-button-container.mp-button-blue:hover:not([disabled]):not(:disabled) {   background-image: -webkit-linear-gradient(bottom, #6cb8ff 0%, #6cb8ff 100%);   background-image: linear-gradient(0deg, #6cb8ff 0%, #6cb8ff 100%);   box-shadow: 0 1.5px 2.5px 0 rgba(0,0,0,0.3); } .mp-button-container.mp-button-primary:active:not([disabled]):not(:disabled), .mp-button-container.mp-button-blue:active:not([disabled]):not(:disabled) {   background-image: -webkit-linear-gradient(bottom, #4ba8ff 0%, #6cb8ff 100%);   background-image: linear-gradient(0deg, #4ba8ff 0%, #6cb8ff 100%);   border-color: #4ba8ff;   box-shadow: 0px 1px 1px 0px rgba(0,0,0,0), inset 0px 2px 2px 0px rgba(0,0,0,0.2);   color: rgba(255,255,255,0.6); } .mp-button-container.mp-button-primary.mp-button-on-blue, .mp-button-container.mp-button-blue.mp-button-on-blue {   border-color: #2687e3;   box-shadow: none; } .mp-button-container.mp-button-primary.mp-button-on-blue:hover:not([disabled]):not(:disabled), .mp-button-container.mp-button-blue.mp-button-on-blue:hover:not([disabled]):not(:disabled) {   background-image: -webkit-linear-gradient(bottom, #4ba8ff 0%, #6cb8ff 100%);   background-image: linear-gradient(0deg, #4ba8ff 0%, #6cb8ff 100%);   box-shadow: 0px 1px 1px 0px rgba(0,0,0,0.2); } .mp-button-container.mp-button-primary.mp-button-on-blue:active:not([disabled]):not(:disabled), .mp-button-container.mp-button-blue.mp-button-on-blue:active:not([disabled]):not(:disabled) {   border-color: #3391e9;   box-shadow: 0px 1px 1px 0px rgba(0,0,0,0), inset 0px 2px 2px 0px rgba(0,0,0,0.2); } .mp-button-container.mp-button-secondary, .mp-button-container.mp-button-grey {   background-image: -webkit-linear-gradient(bottom, #f9fafc 0%, #fff 100%);   background-image: linear-gradient(0deg, #f9fafc 0%, #fff 100%);   border-color: #c1ccd5;   box-shadow: 0px 1px 1px 0px rgba(0,0,0,0.1);   color: #6e859d; } .mp-button-container.mp-button-secondary:hover:not([disabled]):not(:disabled), .mp-button-container.mp-button-grey:hover:not([disabled]):not(:disabled) {   background-image: -webkit-linear-gradient(bottom, #fff 0%, #fff 100%);   background-image: linear-gradient(0deg, #fff 0%, #fff 100%);   box-shadow: 0 1px 2px 0 rgba(0,0,0,0.23);   color: #4ba8ff; } .mp-button-container.mp-button-secondary:active:not([disabled]):not(:disabled), .mp-button-container.mp-button-grey:active:not([disabled]):not(:disabled) {   border-color: #d8e0e6;   box-shadow: 0px 1px 0px 0px #e5eaef, inset 0px 2px 3px 0px #d8e0e6;   color: rgba(110,133,157,0.8); } .mp-button-container.mp-button-secondary.mp-button-on-blue, .mp-button-container.mp-button-grey.mp-button-on-blue {   background-image: none;   background-color: transparent;   border-color: rgba(0,0,0,0);   box-shadow: none;   color: #fff; } .mp-button-container.mp-button-secondary.mp-button-on-blue:hover:not([disabled]):not(:disabled), .mp-button-container.mp-button-grey.mp-button-on-blue:hover:not([disabled]):not(:disabled) {   background-image: none;   box-shadow: none;   border-color: rgba(255,255,255,0.6);   color: #fff; } .mp-button-container.mp-button-secondary.mp-button-on-blue:active:not([disabled]):not(:disabled), .mp-button-container.mp-button-grey.mp-button-on-blue:active:not([disabled]):not(:disabled) {   background-color: #4ba8ff;   border: 1px solid rgba(255,255,255,0.3);   box-shadow: 0px 1px 0px 0px #4ba8ff, inset 0px 2px 3px 0px #3b99f0;   color: rgba(255,255,255,0.6); } .mp-button-container.mp-button-red {   background-image: -webkit-linear-gradient(bottom, #e4567b 0%, #ec7191 100%);   background-image: linear-gradient(0deg, #e4567b 0%, #ec7191 100%);   border-color: #d64174;   color: #fff; } .mp-button-container.mp-button-red:hover:not([disabled]):not(:disabled) {   background-image: -webkit-linear-gradient(bottom, #ec7191 0%, #ec7191 100%);   background-image: linear-gradient(0deg, #ec7191 0%, #ec7191 100%); } .mp-button-container.mp-button-red:active:not([disabled]):not(:disabled) {   background-image: -webkit-linear-gradient(bottom, #e4567b 0%, #ec7191 100%);   background-image: linear-gradient(0deg, #e4567b 0%, #ec7191 100%);   box-shadow: 0px 1px 1px 0px rgba(0,0,0,0), inset 0px 2px 2px 0px rgba(0,0,0,0.2);   color: rgba(255,255,255,0.6); } .mp-button-container.mp-button-purple {   background: #9270e2;   border: 1px solid #7858b8;   color: #fff; } .mp-button-container.mp-button-purple:hover:not([disabled]):not(:disabled) {   background: #a081ea;   border: 1px solid #9270e2; } .mp-button-container.mp-button-modal {   background-image: none;   border-radius: 0 0 6px 6px;   border: none;   color: #fff;   font-size: 15px;   font-weight: bold;   height: 60px;   letter-spacing: 0.7px;   padding: 0;   display: -webkit-box;   display: -ms-flexbox;   display: flex;   text-transform: none;   -webkit-transition: background 200ms;   transition: background 200ms; } .mp-button-container.mp-button-modal:hover:not([disabled]):not(:disabled) {   border: none; } .mp-button-container.mp-button-modal.mp-button-primary, .mp-button-container.mp-button-modal.mp-button-blue {   background: #4ba8ff;   box-shadow: inset 0 1px 0 0 #3b99f0; } .mp-button-container.mp-button-modal.mp-button-primary:hover:not([disabled]):not(:disabled), .mp-button-container.mp-button-modal.mp-button-blue:hover:not([disabled]):not(:disabled) {   background: #6cb8ff; } .mp-button-container.mp-button-modal.mp-button-purple {   box-shadow: inset 0 1px 0 0 #7858b8; } ';
