...
/***/ function(module, exports, __webpack_require__) {
	...
	var template = function render(locals) {
	  locals = locals || {};;;var result_of_with = function ($component, $helpers, Boolean, Object, alertIcon, document, state) {
	    var h = __webpack_require__(348);function generateLiteralWidget(id, contents) {
	      function LiteralWidget(id, contents) {
	        this.name = 'LiteralWidget';this.id = id;this.contents = contents;
	      }LiteralWidget.prototype.type = 'Widget';LiteralWidget.prototype.init = function () {
	    ...
	    };return { value: h("div", { "className": [].concat('mp-modal-stage').concat(__objToAttrs({ 'mp-modal-alert': $component.isAttributeEnabled('alert'), 'mp-modal-absolute': $component.isAttributeEnabled('not-fullscreen'), 'mp-modal-closed': state === 'closed' })).filter(Boolean).join(' ') }, [function () {
	        var __jade_nodes = [];__jade_nodes.push($helpers.getType() === 'modal' ? h("div", { "onclick": $helpers.backdropClicked, "className": [].concat('mp-modal-backdrop').concat('mp-modal-' + state + '').filter(Boolean).join(' ') }) : undefined);__jade_nodes.push(h("div", { "className": [].concat('mp-modal-wrapper').filter(Boolean).join(' ') }, [h("div", { "style": $helpers.getModalStyles(), "className": [].concat('mp-modal-main').concat('mp-modal-' + state + '').filter(Boolean).join(' ') }, [function () {
	  ...
	  }.call(this, "$component" in locals ? locals.$component : typeof $component !== "undefined" ? $component : undefined, "$helpers" in locals ? locals.$helpers : typeof $helpers !== "undefined" ? $helpers : undefined, "Boolean" in locals ? locals.Boolean : typeof Boolean !== "undefined" ? Boolean : undefined, "Object" in locals ? locals.Object : typeof Object !== "undefined" ? Object : undefined, "alertIcon" in locals ? locals.alertIcon : typeof alertIcon !== "undefined" ? alertIcon : undefined, "document" in locals ? locals.document : typeof document !== "undefined" ? document : undefined, "state" in locals ? locals.state : typeof state !== "undefined" ? state : undefined);if (result_of_with) return result_of_with.value;
	...
	var MPModal = function (_Component) {
	  ...
	  _createClass(MPModal, [{
	    ...
	    value: function attachedCallback() {
	      ...
	      this._onAnimationEnd = function (e) {
	        ...
	        switch (_this2.state.state) {
	          case STATE_OPENING:
	            _this2.update({ state: STATE_OPEN });
	            _this2.dispatchEvent(new CustomEvent('change', { detail: { state: STATE_OPEN } }));
	            break;
	          case STATE_CLOSING:
	            _this2.update({ state: STATE_CLOSED });
	            _this2.dispatchEvent(new CustomEvent('change', { detail: { state: STATE_CLOSED } }));
	            break;
	        }
	      };
	    ...
	    get: function get() {
	      ...
	      return {
	        css: css,
	        template: template, useShadowDom: true,
	        defaultState: {
	          state: STATE_CLOSED
	        },
	        helpers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var template = function render(locals) {
	  locals = locals || {};;;var result_of_with = function (Boolean) {
	    var h = __webpack_require__(348);return { value: h("div", { "className": [].concat('mp-tooltip-wrapper').concat('mp-tooltip-hidden').filter(Boolean).join(' ') }, [h("div", { "className": [].concat('mp-tooltip-main').filter(Boolean).join(' ') }, [h("content")])]) };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _parentFrame = __webpack_require__(353);
	...
	var _trackingSetup = __webpack_require__(354);
	...
	var _mpApp = __webpack_require__(357);

	var _mpApp2 = _interopRequireDefault(_mpApp);

	var _persistence = __webpack_require__(358);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mixpanelBrowser = __webpack_require__(355);

	var _mixpanelBrowser2 = _interopRequireDefault(_mixpanelBrowser);

	var _rollbarBrowser = __webpack_require__(356);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _array = __webpack_require__(361);
